...
public class ColorMetaballsEditor : Editor {
	...
	public void OnSceneGUI(){
		...
		for(int i=0; i < metaballTarget.positions.Length; i++){
			...
			var fmh_84_70_638826864659741096 = Quaternion.identity; Vector3 pos = Handles.FreeMoveHandle(metaballTarget.positions[i], 0.03f, Vector3.zero, Handles.DotHandleCap);
			if (EditorGUI.EndChangeCheck())
			{
